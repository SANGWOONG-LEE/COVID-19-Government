...
# Introduction
First paragraph : broader context for motivation


Second paragraph : some detail about what the paper is about

Third paragraph: a clear gap that needs to be filled

Fourth: what was done, what was found 
...
First, to make the demarcation between data session and appendix, I focused on two parts: whether there existed different patterns or noticeable changes between two graphs 2018 and 2021. For instance, figure \@ref(fig:fig7) shows us same pattern between 2018 and 2022, and there exists subtle changes. On the other hand, although figure \@ref(fig:fig6) presents the same pattern, changes in percentage are relatively fluctuating than others. For an another example, figure \@ref(fig:fig2) presents different pattern between 2018 and 2021. Therefore, with respect to two the aspects, I am going to explain my data here.
